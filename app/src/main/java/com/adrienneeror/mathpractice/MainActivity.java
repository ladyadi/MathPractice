...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_addition) {
            // Create a new intent to open addition
            ...
            // Create a new intent to open subtraction
            ...
            // Create a new intent to open multiplication
            Intent multiplicationIntent = new Intent(MainActivity.this, MultiplicationActivity.class);
            startActivity(multiplicationIntent);
        }
        else if (id == R.id.nav_division) {
            // Create a new intent to open division
